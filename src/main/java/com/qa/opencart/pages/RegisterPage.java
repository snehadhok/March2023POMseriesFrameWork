...
public class RegisterPage {
	...
	public boolean registerUser(String firstName, String lastName, String email,
		...
		String sucessMesg=eleUtil.waitForElementVisible(this.successMessg, AppConstants.MEDIUM_TIME_OUT).getText();
		System.out.println(sucessMesg);
		if (sucessMesg.contains(AppConstants.USER_REGISTER_SUCCESS_MESSG)) {	
